...
sources:
  ...
  - "Apple, NameDrop iOS 17 documentation"
  - "Coto Academy and JoynTokyo, meishi koukan etiquette guides"
  - "UPrinting and Wave Connect business card industry statistics, 2025"
  - "QRCodeChimp, Digital Business Card Statistics (2026)"
---
...
- Bret Easton Ellis, *American Psycho* (New York: Vintage, 1991). The business-card scene appears in the chapter titled "Pastels."
- Merry Ellen Scofield, "House of Cards: The Politics of Calling Card Etiquette in Nineteenth-Century Washington," *Commonplace: The Journal of Early American Life* 16, no. 4 (September 2016). The best short scholarly history of the calling-card system in nineteenth-century America.
...
- For Japanese *meishi* etiquette, English-language overviews are maintained by Coto Academy (Tokyo), JoynTokyo, and Asian Business Cards. The detail on cards-as-extension-of-the-person is best documented in Coto Academy's exchange guide.
- Apple's NameDrop feature was introduced in iOS 17. Apple's developer and support documentation describes the contact-exchange flow.
- Industry figures on the contemporary business-card market are compiled from sources including UPrinting's *Business Card Statistics* (2025), Wave Connect's *Business Card Statistics* (2025), and QRCodeChimp's *Digital Business Card Statistics* (2026). Estimates vary widely across sources; figures cited in this piece reflect the range, not a single authoritative count.
